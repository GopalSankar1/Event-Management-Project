<header class="bgImage1" style="background-color: #E14D2A">

    <nav class="navbar">
        <div class="container-fluid" style="background-color: #E14D2A;">
            <div class="navbar-header"><!--website name/title-->
                <?php
                require_once 'utils/functions.php';
                echo '<a href = "index.php" class = "navbar-brand" style="color: white;">
...
<?php
    ...
    <div class = "col-md-12">
        <div class = "container" style="background-color:#E14D2A;">
            <div align="center"><!--jumbotron-->
                <h1 style="color: #fff; font-size: 8rem; font-family: 'Oswald', sans-serif;">Event Management</h1><!--jumbotron heading-->
                <p style="color: #fff; font-size: 2rem; font-family: 'Montserrat', sans-serif;"><!--jumbotron content-->
                Organize facilities and manage all event’s details such as decor, catering, entertainment, transportation, location, invitee list, special guests, equipment, promotional material
                </p>
                <p id="dateAndTime" style="color: #B2B2B2;"></p>
            </div>
        </div>
    </div>
<!DOCTYPE html>
...
<ul id="carousel" class="elastislide-list">
  <li><img src="https://blog.intostudy.com/wp-content/uploads/2016/10/Lights-.gif" alt="img2" /></li>
